...
#stem = "/u/project/ngarud/Garud_lab/BIG_2021_microbiome_evolution/data/midas_output_v1.2.1/"
...
filename="/u/project/ngarud/sarahbal/BIG_2021_microbiome_evolution/strainfinder_output/strain_dict.pickle"
with open(filename, 'rb') as handle:
    strain_dict = pickle.load(handle)
if species in strain_dict.keys():
    if sample in strain_dict[species]["Africa"]:
