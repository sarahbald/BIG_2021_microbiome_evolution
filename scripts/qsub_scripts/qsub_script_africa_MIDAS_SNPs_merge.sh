#!/bin/bash
#$ -N snps_merge
#$ -e /u/project/ngarud/Garud_lab/BIG_2021_microbiome_evolution/scripts/snps_error
#$ -o /u/project/ngarud/Garud_lab/BIG_2021_microbiome_evolution/scripts/snps_output
#$ -cwd
#$ -r y
#$ -j y
#$ -l time=120:00:00
