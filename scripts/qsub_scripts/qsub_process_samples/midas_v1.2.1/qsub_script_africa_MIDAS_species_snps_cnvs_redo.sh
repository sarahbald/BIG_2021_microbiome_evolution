#!/bin/bash
#$ -N MIDAS_1
#$ -e /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/postproc_redo_error
#$ -o /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/postproc_redo_output
#$ -cwd
#$ -r y
#$ -j y
#$ -l time=120:00:00
...
#done
#} < /u/project/ngarud/wrshoema/negative_selection_microbiome/data/madagascar/PRJNA485056_run_accessions_redo.txt
...
} < /u/project/ngarud/wrshoema/negative_selection_microbiome/data/madagascar/PRJNA504891_run_accessions_redo.txt

PRJNA504891_run_accessions_redo.txt
PRJNA504891_run_accessions_redo.txt
