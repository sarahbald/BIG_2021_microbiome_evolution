...
do
  ...
  #run_midas.py genes $OUTDIR -1 $fastq1 -2 $fastq2 q--remove_temp
  run_midas.py snps $OUTDIR -1 $fastq1 -2 $fastq2
done


#samtools view -h /u/project/ngarud/wrshoema/madagascar_data/data/midas_output/SRR7658629/snps/temp/genomes.bam NZ_GG703852 >> /u/project/ngarud/wrshoema/madagascar_data/NZ_GG703852.bam

# run view command on bam command
#/u/project/ngarud/wrshoema/madagascar_data/data/midas_output/SRR7658629/snps/species.txt


#samtools view -T /u/project/ngarud/Garud_lab/midas_db_v1.2/rep_genomes/Prevotella_copri_61740/genome.fna.gz NZ_GG703852.bam > NZ_GG703852.bam

#genome.fna.gz


#samtools fastq NZ_GG703852.bam \
#    -1 NZ_GG703852_R1.fastq.gz \
#    -2 NZ_GG703852_R2.fastq.gz \
